...
export const defaultMessages = {
  ...
  ...getGoupType(GroupMsgs.MsgExec, 'Execute Group Proposal'),
  ...getGoupType(GroupMsgs.MsgLeaveGroup, 'Leave Group'),
  ...getGoupType(GroupMsgs.MsgSubmitProposal, 'Submit Group Proposal'),
  ...
  ...getGoupType(GroupMsgs.MsgUpdateGroupPolicyAdmin, 'Update Group Policy Admin'),
  ...getGoupType(GroupMsgs.MsgUpdateGroupPolicyDecisionPolicy, 'Update Group Decision Policy'),
  ...getGoupType(GroupMsgs.MsgUpdateGroupPolicyMetadata, 'Update Group Policy Metadata'),
  ...getGoupType(GroupMsgs.MsgVote, 'Group Proposal Vote'),
