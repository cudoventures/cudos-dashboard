...
export type GetGravityMessagesByAddressListenerSubscription = { messagesByAddress: Array<{ __typename?: 'message', transaction?: { __typename?: 'transaction', height: any, hash: string, success: boolean, messages: any, logs?: any | null, block: { __typename?: 'block', height: any, timestamp: any } } | null }> };
...
export type GetGravityMessagesByAddressQuery = { messagesByAddress: Array<{ __typename?: 'message', transaction?: { __typename?: 'transaction', height: any, hash: string, success: boolean, messages: any, logs?: any | null, block: { __typename?: 'block', height: any, timestamp: any } } | null }> };
...
export type GetMessagesByAddressListenerSubscription = { messagesByAddress: Array<{ __typename?: 'message', transaction?: { __typename?: 'transaction', height: any, hash: string, success: boolean, messages: any, logs?: any | null, block: { __typename?: 'block', height: any, timestamp: any } } | null }> };
...
export type GetMessagesByAddressDistinctListenerSubscriptionVariables = Exact<{
  address?: InputMaybe<Scalars['_text']>;
  limit?: InputMaybe<Scalars['bigint']>;
  offset?: InputMaybe<Scalars['bigint']>;
  types?: InputMaybe<Scalars['_text']>;
...
export type GetMessagesByAddressDistinctListenerSubscription = { messagesByAddress: Array<{ __typename?: 'distinct_message', transaction?: { __typename?: 'transaction', height: any, hash: string, success: boolean, messages: any, logs?: any | null, block: { __typename?: 'block', height: any, timestamp: any } } | null }> };

export type GetMessagesByAddressDistinctQueryVariables = Exact<{
  address?: InputMaybe<Scalars['_text']>;
  limit?: InputMaybe<Scalars['bigint']>;
  offset?: InputMaybe<Scalars['bigint']>;
  types?: InputMaybe<Scalars['_text']>;
...
export type GetMessagesByAddressDistinctQuery = { messagesByAddress: Array<{ __typename?: 'distinct_message', transaction?: { __typename?: 'transaction', height: any, hash: string, success: boolean, messages: any, logs?: any | null, block: { __typename?: 'block', height: any, timestamp: any } } | null }> };

export type VotingPowerAggregateSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type VotingPowerAggregateSubscription = { validatorVotingPowerAggregate: { __typename?: 'validator_voting_power_aggregate', aggregate?: { __typename?: 'validator_voting_power_aggregate_fields', sum?: { __typename?: 'validator_voting_power_sum_fields', votingPower?: any | null } | null } | null } };

export type StakingPoolSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type StakingPoolSubscription = { stakingPool: Array<{ __typename?: 'staking_pool', bonded: any }> };
...
export type ProposalsListenerSubscription = { proposals: Array<{ __typename?: 'proposal', title: string, status?: string | null, description: string, submit_time: any, voting_start_time?: any | null, voting_end_time?: any | null, proposer_address: string, content: any, proposalId: number }> };
...
export type ProposalsQuery = { proposals: Array<{ __typename?: 'proposal', title: string, status?: string | null, description: string, submit_time: any, voting_start_time?: any | null, voting_end_time?: any | null, proposer_address: string, content: any, proposalId: number }>, total: { __typename?: 'proposal_aggregate', aggregate?: { __typename?: 'proposal_aggregate_fields', count: number } | null } };
 ...
 * });
 */
export function useGetMessagesByAddressListenerSubscription(baseOptions?: Apollo.SubscriptionHookOptions<GetMessagesByAddressListenerSubscription, GetMessagesByAddressListenerSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetMessagesByAddressListenerSubscription, GetMessagesByAddressListenerSubscriptionVariables>(GetMessagesByAddressListenerDocument, options);
      }
export type GetMessagesByAddressListenerSubscriptionHookResult = ReturnType<typeof useGetMessagesByAddressListenerSubscription>;
export type GetMessagesByAddressListenerSubscriptionResult = Apollo.SubscriptionResult<GetMessagesByAddressListenerSubscription>;
...
export const GetMessagesByAddressDistinctListenerDocument = gql`
    subscription GetMessagesByAddressDistinctListener($address: _text, $limit: bigint = 50, $offset: bigint = 0, $types: _text = "{}") {
  messagesByAddress: messages_by_address_distinct_on_tx_hash(
    args: {addresses: $address, types: $types, limit: $limit, offset: $offset}
  ) {
    transaction {
      height
...
/**
 * __useGetMessagesByAddressDistinctListenerSubscription__
 *
 * To run a query within a React component, call `useGetMessagesByAddressDistinctListenerSubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetMessagesByAddressDistinctListenerSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMessagesByAddressDistinctListenerSubscription({
 *   variables: {
 *      address: // value for 'address'
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 ...
 * });
 */
export function useGetMessagesByAddressDistinctListenerSubscription(baseOptions?: Apollo.SubscriptionHookOptions<GetMessagesByAddressDistinctListenerSubscription, GetMessagesByAddressDistinctListenerSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetMessagesByAddressDistinctListenerSubscription, GetMessagesByAddressDistinctListenerSubscriptionVariables>(GetMessagesByAddressDistinctListenerDocument, options);
      }
export type GetMessagesByAddressDistinctListenerSubscriptionHookResult = ReturnType<typeof useGetMessagesByAddressDistinctListenerSubscription>;
export type GetMessagesByAddressDistinctListenerSubscriptionResult = Apollo.SubscriptionResult<GetMessagesByAddressDistinctListenerSubscription>;
export const GetMessagesByAddressDistinctDocument = gql`
...
/**
 * __useGetMessagesByAddressDistinctQuery__
 *
 * To run a query within a React component, call `useGetMessagesByAddressDistinctQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMessagesByAddressDistinctQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMessagesByAddressDistinctQuery({
 *   variables: {
 *      address: // value for 'address'
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 ...
 * });
 */
export function useGetMessagesByAddressDistinctQuery(baseOptions?: Apollo.QueryHookOptions<GetMessagesByAddressDistinctQuery, GetMessagesByAddressDistinctQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMessagesByAddressDistinctQuery, GetMessagesByAddressDistinctQueryVariables>(GetMessagesByAddressDistinctDocument, options);
      }
export function useGetMessagesByAddressDistinctLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMessagesByAddressDistinctQuery, GetMessagesByAddressDistinctQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMessagesByAddressDistinctQuery, GetMessagesByAddressDistinctQueryVariables>(GetMessagesByAddressDistinctDocument, options);
        }
export type GetMessagesByAddressDistinctQueryHookResult = ReturnType<typeof useGetMessagesByAddressDistinctQuery>;
export type GetMessagesByAddressDistinctLazyQueryHookResult = ReturnType<typeof useGetMessagesByAddressDistinctLazyQuery>;
export type GetMessagesByAddressDistinctQueryResult = Apollo.QueryResult<GetMessagesByAddressDistinctQuery, GetMessagesByAddressDistinctQueryVariables>;
 ...
 * });
 */
export function useVotingPowerAggregateSubscription(baseOptions?: Apollo.SubscriptionHookOptions<VotingPowerAggregateSubscription, VotingPowerAggregateSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<VotingPowerAggregateSubscription, VotingPowerAggregateSubscriptionVariables>(VotingPowerAggregateDocument, options);
      }
export type VotingPowerAggregateSubscriptionHookResult = ReturnType<typeof useVotingPowerAggregateSubscription>;
export type VotingPowerAggregateSubscriptionResult = Apollo.SubscriptionResult<VotingPowerAggregateSubscription>;
 ...
 * });
 */
export function useStakingPoolSubscription(baseOptions?: Apollo.SubscriptionHookOptions<StakingPoolSubscription, StakingPoolSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<StakingPoolSubscription, StakingPoolSubscriptionVariables>(StakingPoolDocument, options);
      }
export type StakingPoolSubscriptionHookResult = ReturnType<typeof useStakingPoolSubscription>;
export type StakingPoolSubscriptionResult = Apollo.SubscriptionResult<StakingPoolSubscription>;
...
/**
 * __useProposalsListenerSubscription__
 *
 * To run a query within a React component, call `useProposalsListenerSubscription` and pass it any options that fit your needs.
 * When your component renders, `useProposalsListenerSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProposalsListenerSubscription({
 *   variables: {
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useProposalsListenerSubscription(baseOptions?: Apollo.SubscriptionHookOptions<ProposalsListenerSubscription, ProposalsListenerSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ProposalsListenerSubscription, ProposalsListenerSubscriptionVariables>(ProposalsListenerDocument, options);
      }
export type ProposalsListenerSubscriptionHookResult = ReturnType<typeof useProposalsListenerSubscription>;
export type ProposalsListenerSubscriptionResult = Apollo.SubscriptionResult<ProposalsListenerSubscription>;
...
export const ValidatorsDocument = gql`
  ...
  validator {
    ...
    validatorDescription: validator_descriptions(limit: 1, order_by: {height: desc}) {
      avatarUrl: avatar_url
      moniker
    }
  }
